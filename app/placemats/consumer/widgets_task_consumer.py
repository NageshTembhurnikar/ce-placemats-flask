...
class WidgetsTaskConsumer(BaseConsumer):
    ...
    def _concept_map_keywords_journal_author(self, task_info: dict):
        ...
        concept_map_data, author_journal_map_data = concept_map(keywords.pmids_to_keywords, keywords.keyword_to_pmids, keywords.pmid_to_authors, keywords.keyword_to_jtitle, keywords.keyword_to_authors )
        return[{'concept_map_data': concept_map_data,
                'author_journal_map_data': author_journal_map_data}]
