...
class WidgetsTaskConsumer(BaseConsumer):
    ...
    def _radial_tree(self, task_info: dict):
        ...
        if cts:
            aact_tree_data = radial_tree_for_clinical_trials(cts.nctid_to_title, cts.nctid_to_status, cts.nctid_to_conditions, cts.nctid_to_phase, cts.nctid_to_sponsors, cts.nctid_to_enrollment, cts.nctid_to_start, cts.nctid_to_end, term)

        return [{'mesh_tree': radial_tree_data_mesh,
                 'trials_info': aact_tree_data}]
